...
def tocar():
    ...
    def confirmar():
        ...
        if rsp == '17/05':
            text3 = tk.Label(janela_ms, fg='black', bg='#117812', text='\n\nTim Bernades, BB', font=('Arial', 14))
            text3.pack(pady=30)
            ...
            text4 = tk.Label(janela_ms, fg='Black', bg='#b4b5ab', text='\n\nTribalistas, Aliança', font=('Arial', 14))
            text4.pack(pady=20)
            ...
            text5 = tk.Label(janela_ms, fg='Black', bg='#7db6ca', text='\n\nRoberto Carlos, Eu te darei o céu', font=('Arial', 14))
            text5.pack(pady=20)
            ...
            text6 = tk.Label(janela_ms, fg='Black', bg='#973b40', text='\n\nNatiruts, Mergulhei nos seus olhos', font=('Arial', 14))
            text6.pack(pady=20)
            ...
            text7 = tk.Label(janela_ms, fg='Black', bg='#d0ccae', text='\n\nMarcelo Jeneci, Pra sonhar', font=('Arial', 14))
            text7.pack(pady=20)
            ...
            text8 = tk.Label(janela_ms, fg='Black', bg='#c5c1a6', text='\n\nAnavitória, No escuro', font=('Arial', 14))
            text8.pack(pady=20)
            ...
            text9 = tk.Label(janela_ms, fg='Black', bg='#6b5d38', text='\n\nToquinho, Carolina, Carol bela', font=('Arial', 14))
            text9.pack(pady=20)
